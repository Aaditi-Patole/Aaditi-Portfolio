	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Aaditi Patole",
					reply_to: user_email,
					to_email: "aaditipatole@gmail.com",
        ...
        <div className='relative z-0 bg-black w-screen h-screen mt-12'>   
			<div className='text-white contact overflow-x-hidden pt-12 mt-8 ' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
					...
					<h2 className='text-4xl font-extrabold mt-2 bg-clip-text text-transparent bg-gradient-to-r from-gray-500 to-pink-500'>Contact.</h2>
					<form
						ref={formRef}
					...
					>
						...
						<button
							type='submit'
							className='pt-2 px-8 py-2 rounded-xl outline-none w-fit font-bold shadow-md bg-gray-900'
						>
